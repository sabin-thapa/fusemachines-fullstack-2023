...
const headerQuestionElement = document.getElementById('header-question')
...
function startQuiz() {
  ...
  headerQuestionElement.classList.add('hide')
...
function quitQuiz() {
  ...
  headerQuestionElement.classList.remove('hide')
}
